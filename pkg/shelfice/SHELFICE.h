...
C                           Used with ice shelf fwflx ctrl. 
C   maskSHIWet        ::  Mask=1 at surface for non-obcs wet points at 
C                           any depth. =maskC for rest of k values
C                           Used with eta0, bottomdrag ctrls w/ shelfice

      COMMON /SHELFICE_MASKS_CTRL/ 
     &     maskSHI,
     &     maskSHIWet
